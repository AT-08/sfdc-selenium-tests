Feature: Contacts feature
  ...
  Scenario: Edit contact with all fields filled
    ...
    And I can click on "Pablo Grillosss" "CONTACT" at list on Main Page
    ...
    Then I can go to "CONTACT" Section
    And I can verify if "Pepe Grillo" "CONTACT" was created/modified on Detail Page

  Scenario: Delete account
    Given I can go to "CONTACT" Section
    When I can click on "Pablo Grillosss" "CONTACT" at list on Main Page
    And I can click on Delete Button
    And I can confirm Delete alert
    Then I can verify that "Pablo Grillosss" "CONTACT" was deleted
