Feature: Modify/delete a campaign
  ...
  Scenario: Create a new campaign with only mandatory fields filled
    ...
    And I can verify if "Campaign3" was created/modified on Detail Page

  Scenario: Edit account with all fields filled
    When I can go to "CAMPAIGN" Section
    And I can click on "Campaign3" at list on Main Page
    ...
    Then I can go to "CAMPAIGN" Section
    And I can verify if "Campaign4" was created/modified on Detail Page

  Scenario: Delete account
    Given I can go to "CAMPAIGN" Section
    When I can click on "Campaign4" at list on Main Page
    And I can click on Delete Button
    And I can confirm Delete alert
    Then I can verify that "Campaign4" was deleted